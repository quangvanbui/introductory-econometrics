...
\begin{align*}
	...
	H_1&: \beta_4 \neq 0
\end{align*}
$$t = \dfrac{\hat{\beta}_4 - \beta_{4}}{se(\hat{\beta}_4)} = \dfrac{\hat{\beta}_4 - 0}{se(\hat{\beta}_4)} = \dfrac{\hat{\beta}_4}{se(\hat{\beta}_4)} \sim t_{n-k-1} \quad under\ H_0$$
$$degrees\ of\ freedom: n-k-1 = 556-3-1 = 522$$
$$t_{calc} = \dfrac{\hat{\beta}_4}{se(\hat{\beta}_4)} = -6.1639$$
$$p-value = 0.0000$$
\noindent Since $p-value = 0.0000 < \alpha = 0.01$ we reject $H_0$ and conclude that there is sufficient evidence from our sample to suggest that $exper^2$ is statistically significant at explaining $log(wage)$.
